        ...
        <div className="vet-pricing-grid" style={{ justifyContent: 'center', marginTop: '3rem' }}>
          ...
          <div className="vet-price-card">
            <div>
              ...
              <ul className="vet-plan-features">
                ...
                <li className="vet-plan-feature-item"><Check size={16} style={{ color: '#ea580c' }} /> Patient Records & Appointments</li>
          ...
          <div className="vet-price-card featured" style={{ borderColor: '#ea580c' }}>
            ...
            <div>
              ...
              <ul className="vet-plan-features">
                ...
                <li className="vet-plan-feature-item"><Check size={16} style={{ color: '#ea580c' }} /> Billing & POS + Inventory Management</li>
                <li className="vet-plan-feature-item"><Check size={16} style={{ color: '#ea580c' }} /> Duration: Monthly</li>
              </ul>
            </div>
          ...
          <div className="vet-price-card">
            <div>
              ...
              <ul className="vet-plan-features">
                <li className="vet-plan-feature-item"><Check size={16} style={{ color: '#ea580c' }} /> Advanced clinic automation & multi-doctor</li>
                <li className="vet-plan-feature-item"><Check size={16} style={{ color: '#ea580c' }} /> Reports, Analytics & Automated Reminders</li>
                <li className="vet-plan-feature-item"><Check size={16} style={{ color: '#ea580c' }} /> Duration: Monthly</li>
              </ul>
            </div>
          ...
          {/* Plan 4: Custom */}
          <div className="vet-price-card" style={{ borderStyle: 'dashed' }}>
            <div>
              <div className="vet-plan-name">Custom Plan</div>
              <div className="vet-plan-price-row">
                <span className="vet-plan-price" style={{ fontSize: '1.5rem', color: '#0284c7' }}>Custom</span>
                <span className="vet-plan-unit">Quote</span>
              </div>
              <ul className="vet-plan-features">
